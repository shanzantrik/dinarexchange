        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            <Link
              onClick={onClose}
              href="/contact"
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2 w-full"
            >
          ...
          <div className="border-t border-gray-200 pt-6 mb-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-blue-400 transition-colors duration-200 p-2 hover:bg-gray-100 rounded-lg"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="text-gray-600 hover:text-red-500 transition-colors duration-200 p-2 hover:bg-gray-100 rounded-lg"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

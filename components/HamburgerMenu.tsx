  ...
  return (
    ...
    >
      <div className="w-80 bg-white h-full shadow-xl overflow-y-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-primary-600 to-orange-500 text-white p-6">
          ...
          <div className="border-t border-gray-200 pt-6 mb-6">
            ...
            <div className="flex items-center space-x-4">
              <a
                ...
                className="text-gray-600 hover:text-primary-600 transition-colors duration-200 p-2 hover:bg-gray-100 rounded-lg"
              >
